...
#	print hltMatch
	...
	#filling an array with jet 4-vectors for jets pt > 30 and |eta| < 2.5, an array of tau21s, and an array of bbtag values
        jets = []
	jet_tau = []
	jet_bbtag = []
	...
	if len(jets) < 2: # two jets with pt > 30 and |eta| < 2.5
		continue
...
#	print "Number of Higgs Tags: " + str(nHiggsTags[0])
	...
	#matching unpruned jets to pruned jets, filling pruned jets array
        ujets = []
