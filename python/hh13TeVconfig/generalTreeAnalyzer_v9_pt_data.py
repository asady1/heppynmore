...
finaldijetmass = ROOT.TH1F("finaldijetmass", "Dijet Mass After 2 BB tags cut", 100, 0, 10000)
finaldjm2 = ROOT.TH1F("finaldjm2", "Dijet Mass With 2 Higgs Tags", 100, 0, 10000)
finaldjm1 = ROOT.TH1F("finaldjm1", "Dijet Mass With 1 Higgs Tags", 100, 0, 10000)
finaldjm0 = ROOT.TH1F("finaldjm0", "Dijet Mass With 0 Higgs Tags", 100, 0, 10000)
nHiggs = ROOT.TH1F("nHiggs", "Number of Higgs Tags", 3, -0.5, 2.5)
...
njets = ROOT.TH1F("njets", "Number of jet with pt > 30 |eta| < 2.4, passing the trigger selection", 15, -0.5, 14.5)
jet_H1_id = ROOT.TH1F("jet_H1_id", "idx selected H1", 15, -0.5, 14.5)
jet_H2_id = ROOT.TH1F("jet_H2_id", "idx selected H2", 15, -0.5,14.5)


#njet = ROOT.TH1F("njet", "Number of jet with pt > 30 |eta| < 2.4, passing the trigger selection", 15., -0.5, 14.5)
...
#	hMass = treeMine.GenHiggsBoson_mass
	hltMatch = treeMine.HLT_BIT_HLT_PFHT800_v
...
#	print hltMatch
	...
	if triggerpass[0] > 0:
		c0.Fill(triggerpass[0])
        jets = []
	jet_tau = []
	jet_bbtag = []
#	ht = 0
	#filling array with ungroomed jets that have pt > 30 and |eta| < 2.5, as well as tau21 array and bbtag array
...
#		    ht += jettemp.Pt()
	...
	#trying to account for MC trigger being HT900 rather than the data HT800
#	if ht < 900:
#		continue
	if triggerpass[0] > 0:
		c2.Fill(triggerpass[0])
	...
	if triggerpass[0] > 0:
		jet_H1_id.Fill(idxH1)
		jet_H2_id.Fill(idxH2)


	#higgs tagging - turned off for data
#	hjets = []
...
#	print "Higgs Tag 1: " + str(h1)
#	h2 = MatchCollection(hjets, jets[idxH2])
#	print "Higgs Tag 2: " + str(h2)
#	nHiggsTags[0] = 0
#	if h1 > -1:
#		nHiggsTags[0] += 1
#	if h2 > -1:
#		nHiggsTags[0] += 1
#	print "Number of Higgs Tags: " + str(nHiggsTags[0])

	#filling array of pruned jets and matching with the unpruned jets
        ujets = []
	...
	#mass cut - here we use pruned mass - ONLY here 
        ...
        if 105 < jet2pmass[0] < 135:
                passjet2mass +=1
        if passjet1mass > 0 and passjet2mass > 0 and triggerpass[0] > 0:
                c6.Fill(dijetm)
	...
	if jet1t21 < 0.6:
		passjet1taucut +=1
	if passjet1mass> 0 and passjet2mass > 0 and passjet1taucut > 0 and triggerpass[0] > 0:
		c7.Fill(dijetm) 
	if jet2t21 < 0.6:
		passjet2taucut +=1
	if passjet1mass> 0 and passjet2mass > 0 and passjet1taucut > 0 and passjet2taucut > 0 and triggerpass[0] > 0:
		c8.Fill(dijetm)
...
#	
	...
	if passjet1mass> 0 and passjet2mass > 0 and passjet1taucut > 0 and passjet2taucut > 0 and jet1bbtag[0] > -0.5 and jet2bbtag[0] > -0.5 and triggerpass[0] > 0:
		finaldijetmass.Fill(dijetm)
	
#	if passjet1mass> 0 and passjet2mass > 0 and passjet1taucut > 0 and passjet2taucut > 0 and jet1bbtag[0] > -0.5 and jet2bbtag[0] > -0.5 and nHiggsTags[0] == 2 and triggerpass[0] > 0:
#		finaldjm2.Fill(dijetm)
#	if passjet1mass> 0 and passjet2mass > 0 and passjet1taucut > 0 and passjet2taucut > 0 and jet1bbtag[0] > -0.5 and jet2bbtag[0] > -0.5 and nHiggsTags[0] == 1 and triggerpass[0] > 0:
#		finaldjm1.Fill(dijetm)
#	if passjet1mass> 0 and passjet2mass > 0 and passjet1taucut > 0 and passjet2taucut > 0 and jet1bbtag[0] > -0.5 and jet2bbtag[0] > -0.5 and nHiggsTags[0] == 0 and triggerpass[0] > 0:
#		finaldjm0.Fill(dijetm)
	...
	if passjet1taucut > 0 and passjet2taucut > 0 and triggerpass[0] > 0:
		d2.Fill(dijetm)
	...
	if passjet1mass > 0 and passjet2mass > 0 and passjet1taucut > 0 and passjet2taucut > 0 and passjet1sjb2 > 0 and passjet2sjb2 > 0 and triggerpass[0] > 0:
		d4a.Fill(dijetm)
		j14a.Fill(jet1pmass[0])
		j24a.Fill(jet2pmass[0])
	if passjet1mass > 0 and passjet2mass > 0 and passjet1taucut > 0 and passjet2taucut > 0 and passjet1sjb5 > 0 and passjet2sjb5 > 0 and triggerpass[0] > 0:	
		d4b.Fill(dijetm)
		j14b.Fill(jet1pmass[0])
		j24b.Fill(jet2pmass[0])
	#yes mass yes tau bbtag
	if passjet1mass > 0 and passjet2mass > 0 and passjet1taucut > 0 and passjet2taucut > 0 and passjet1bb2 > 0 and passjet2bb2 > 0 and triggerpass[0] > 0:
		d5a.Fill(dijetm)
		j15a.Fill(jet1pmass[0])
		j25a.Fill(jet2pmass[0])
	if passjet1mass > 0 and passjet2mass > 0 and passjet1taucut > 0 and passjet2taucut > 0 and passjet1bb5 > 0 and passjet2bb5 > 0 and triggerpass[0] > 0:	
	 	d5b.Fill(dijetm)
		j15b.Fill(jet1pmass[0])
		j25b.Fill(jet2pmass[0])
	#no mass no tau subjet btag
	if passjet1sjb2 > 0 and passjet2sjb2 > 0 and triggerpass[0] > 0:
		d6a.Fill(dijetm)
		j16a.Fill(jet1pmass[0])
		j26a.Fill(jet2pmass[0])
	if passjet1sjb5 > 0 and passjet2sjb5 > 0 and triggerpass[0] > 0:
		d6b.Fill(dijetm)
		j16b.Fill(jet1pmass[0])
		j26b.Fill(jet2pmass[0])
        #no mass no tau bbtag
    	if passjet1bb2 > 0 and passjet2bb2 > 0 and triggerpass[0] > 0:
		d7a.Fill(dijetm)
		j17a.Fill(jet1pmass[0])
		j27a.Fill(jet2pmass[0])
	if passjet1bb5 > 0 and passjet2bb5 > 0 and triggerpass[0] > 0:
		d7b.Fill(dijetm)
